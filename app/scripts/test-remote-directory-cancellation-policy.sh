...
grep -Fq "this.client.get('/api/app/v1/media/items?limit=1', cancellation)" "$api"
...
grep -Fq "this.client.get('/api/app/v1/catalog', cancellation)" "$market_api"
...
grep -Fq "this.client.get('/api/app/v1/identity/sessions', cancellation)" "$session_api"
grep -Fq 'this.client.delete(`/api/app/v1/identity/sessions/${safeId}`)' "$session_api"
