...
/** Reader 搜索 Gateway 模型。 */ public final class ReaderSearchGatewayModels {private ReaderSearchGatewayModels(){}
 ...
 public record SearchView(UUID id,UUID taskId,String status,String keyword,String mode,int page,int completedShards,int failedShards,int totalShards,List<Map<String,Object>>results,Instant createdAt,Instant updatedAt){}
}
