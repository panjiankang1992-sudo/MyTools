...
ONEBOT_ACCOUNT_KEY = "qq-napcat"
TOKEN_KEYS = (
    "IMAGE_GENERATION_INTERNAL_TOKEN", "TASK_BUSINESS_IMAGE_GENERATION_TOKEN",
    ...
    "MESSAGING_INTERNAL_TOKEN", "MSGSERVICE_MIGRATION_TOKEN", "ONEBOT_CONNECTOR_INTERNAL_TOKEN",
    "PIKPAK_CONNECTOR_TOKEN", "READER_INTERNAL_TOKEN", "READER_MIGRATION_INTERNAL_TOKEN",
    "STORAGE_INTERNAL_TOKEN", "TELEGRAM_CONNECTOR_INTERNAL_TOKEN",
    "TASK_INTERNAL_TOKEN", "TASK_EXECUTOR_INTERNAL_TOKEN", "TASK_OPERATOR_INTERNAL_TOKEN",
    "TASK_BUSINESS_INTERNAL_TOKEN", "TASK_BUSINESS_MYTOOLS_TOKEN",
    "TASK_BUSINESS_MESSAGING_TOKEN", "TASK_BUSINESS_DRIVE_TOKEN",
    "TASK_BUSINESS_MEDIA_LIBRARY_TOKEN", "TASK_BUSINESS_READER_TOKEN",
    "TASK_BUSINESS_STORAGE_GATEWAY_TOKEN",
    "MESSAGING_REGISTRATION_MAIL_ROUTING_KEY",
    "MESSAGING_REGISTRATION_MAIL_SHADOW_HASH_KEY",
)
DISABLED_FLAGS = (
    "IMAGE_GENERATION_ROUTE_ENABLED", "IMAGE_GENERATION_LOCAL_VALIDATED",
    "IMAGE_GENERATION_STYLE_VALIDATED", "IMAGE_GPU_COORDINATION_VALIDATED", "IMAGE_REMOTE_VALIDATED",
    ...
    "DOWNLOADBOT_LIVE_BRIDGE_ENABLED", "DOWNLOADBOT_SNAPSHOT_EXPORT_ENABLED",
    "DOWNLOADBOT_RECONCILIATION_ENABLED", "DOWNLOADBOT_PIKPAK_EXPORT_ENABLED",
    "LEGACY_ASSET_ADAPTER_EXPORT_ENABLED",
    "MSGSERVICE_ADAPTER_IMPORT_ENABLED", "MSGSERVICE_ADAPTER_EXPORT_ENABLED",
    "ONEBOT_CONNECTOR_ENABLED", "PIKPAK_CONNECTOR_ENABLED", "TELEGRAM_CONNECTOR_ENABLED",
...
def values(manifest: dict[str, Any], download_root: str, storage_root: str,
    ...
    environment = {
        ...
        "TASK_EXECUTOR_MAX_CONCURRENT_TASKS": "12",
        "TASK_EXECUTOR_POLL_MILLISECONDS": "250",
        "TASK_EXECUTOR_RESERVED_CHILD_TASK_SLOTS": "0",
        "MESSAGING_REGISTRATION_MAIL_MODE": "LEGACY",
        "MESSAGING_REGISTRATION_MAIL_CANARY_PERCENT": "0",
        "MESSAGING_REGISTRATION_MAIL_SIDECAR_ENABLED": "false",
        "MESSAGING_REGISTRATION_MAIL_DELIVERY_ENCRYPTION_KEY": base64.b64encode(
            secrets.token_bytes(32)).decode("ascii"),
        "TASK_EXECUTOR_DISK_MINIMUM_USABLE_BYTES": "1073741824",
        "TASK_EXECUTOR_DISK_MINIMUM_USABLE_PERCENT": "5",
        "TASK_EXECUTOR_MAXIMUM_CPU_SECONDS": "21600",
        "TASK_EXECUTOR_MAXIMUM_VIRTUAL_MEMORY_BYTES": "17179869184",
        "TASK_EXECUTOR_MAXIMUM_FILE_BYTES": "107374182400",
        "TASK_EXECUTOR_NODE_NAME": "executor-remote-1",
        "FFMPEG_BINARY": "/usr/bin/ffmpeg",
        "IMAGE_GENERATION_URL": "http://127.0.0.1:23340",
        "IMAGE_GENERATION_ROOT": str(DEPLOYMENT_ROOT / "runtime" / "image-generation"),
        "IMAGE_GPU_LOCK_FILE": str(DEPLOYMENT_ROOT / "runtime" / "gpu.lock"),
        "TASK_SCHEDULER_HTTP_PORT": "23410",
        "TASK_SCHEDULER_URL": "http://127.0.0.1:23410",
        "QQ_CONNECTOR_SCHEDULER_URL": "http://127.0.0.1:23410",
        "QQ_CONNECTOR_ALLOWED_SENDER": "",
        "QQ_CONNECTOR_LOGIN_WAL_PATH": str(
            DEPLOYMENT_ROOT / "runtime" / "qq" / "login-command-wal"),
        "QQ_CONNECTOR_LOGIN_MAX_ATTEMPTS": "9",
        "QQ_CONNECTOR_LOGIN_RETRY_MAX_SECONDS": "60",
        "QQ_CONNECTOR_LOGIN_DEADLINE_SECONDS": "300",
        "QQ_CONNECTOR_LOGIN_WORKER_POLL_SECONDS": "0.5",
        "QQ_CONNECTOR_GATEWAY_STALE_SECONDS": "120",
        "QQ_CONNECTOR_REJECTED_EVENT_MAX_RECORDS": "10000",
        "QQ_CONNECTOR_INBOUND_WAL_PATH": str(
            DEPLOYMENT_ROOT / "runtime" / "qq" / "inbound-wal"),
        "QQ_CONNECTOR_INBOUND_MAX_ATTEMPTS": "9",
        "QQ_CONNECTOR_INBOUND_RETRY_MAX_SECONDS": "60",
        "QQ_CONNECTOR_INBOUND_WORKER_POLL_SECONDS": "1",
        "QQ_CONNECTOR_INBOUND_WORKER_CONCURRENCY": "4",
        "QQ_CONNECTOR_INBOUND_MAX_PENDING_RECORDS": "10000",
        "QQ_CONNECTOR_INBOUND_MAX_PAYLOAD_BYTES": str(16 * 1024 * 1024),
        "QQ_CONNECTOR_INBOUND_MAX_TOTAL_PAYLOAD_BYTES": str(128 * 1024 * 1024),
        "QQ_CONNECTOR_INBOUND_DONE_MAX_RECORDS": "10000",
        "QQ_CONNECTOR_INBOUND_DEAD_MAX_RECORDS": "1000",
        ...
        "DOWNLOAD_HTTP_PROXY": "http://127.0.0.1:17890",
        "GALLERY_DL_BINARY": str(DEPLOYMENT_ROOT / "releases" / "current" / "venv" / "bin"
                                 / "gallery-dl"),
        ...
        "ONEBOT_CONNECTOR_ACCOUNT_KEY": ONEBOT_ACCOUNT_KEY,
        "QQ_CONNECTOR_ONEBOT_ACCOUNT_KEY": ONEBOT_ACCOUNT_KEY,
        "ONEBOT_CONNECTOR_OWNER_ID": "",
        "ONEBOT_CONNECTOR_RELOGIN_REQUEST_PATH": str(
            DEPLOYMENT_ROOT / "runtime" / "onebot" / "relogin.request"),
        "ONEBOT_CONNECTOR_QR_PATH": "/opt/napcat/cache/qrcode.png",
        "ONEBOT_CONNECTOR_INBOUND_WAL_PATH": str(
            DEPLOYMENT_ROOT / "runtime" / "onebot" / "inbound-wal"),
        "ONEBOT_CONNECTOR_WS_URL": "ws://127.0.0.1:3001",
        "ONEBOT_CONNECTOR_MESSAGING_URL": "http://127.0.0.1:23250",
        "MESSAGING_ONEBOT_ACCEPTANCE_RELAY_DELAY_MS": "250",
        "MESSAGING_ONEBOT_FORWARD_RELAY_DELAY_MS": "500",
        "MESSAGE_AUTOMATION_RELAY_DELAY_MS": "250",
        "MESSAGE_AUTOMATION_COMPLETION_RELAY_DELAY_MS": "250",
        "MESSAGE_AUTOMATION_RECONCILIATION_DELAY_MS": "250",
        "MESSAGE_AUTOMATION_ACTION_STATUS_POLL_DELAY_MS": "250",
        "QQ_CONNECTOR_INTENTS": "33554432",
        "TELEGRAM_CONNECTOR_HTTP_HOST": "127.0.0.1",
        "TELEGRAM_CONNECTOR_HTTP_PORT": "23257",
        "TELEGRAM_CONNECTOR_POLL_TIMEOUT": "45",
        "TELEGRAM_CONNECTOR_MAXIMUM_FILE_BYTES": "2147483648",
        "TELEGRAM_CONNECTOR_PIKPAK_BOT": "@pikpak_bot",
        "TELEGRAM_CONNECTOR_PIKPAK_THRESHOLD_BYTES": "20971520",
        "TELEGRAM_CONNECTOR_BUSINESS_CONNECTION_ID": "",
        "TELEGRAM_CONNECTOR_PROXY_URL": "",
    ...
    environment["MESSAGE_PROVIDER_RESOLVER_TOKEN"] = environment["ONEBOT_CONNECTOR_INTERNAL_TOKEN"]
    ...
    environment["MESSAGE_AUTOMATION_COMPLETION_RELAY_ENABLED"] = "true"
