INSERT INTO task_definition (
    ...
    '00000000-0000-4000-8000-000000000572', 'reader_synthesize_audiobook',
    'Synthesize durable chapter audio from frozen audiobook text snapshots',
    ...
    '{"type":"object","required":["generationId","synthesizedChapterCount"],"properties":{"generationId":{"type":"string","format":"uuid"},"synthesizedChapterCount":{"type":"integer","minimum":1}},"additionalProperties":false}',
...
INSERT INTO task_step_definition (
    ...
    '00000000-0000-4000-8000-000000000573', '00000000-0000-4000-8000-000000000572',
    'synthesize_audiobook_chapters', 'Synthesize, validate, and atomically publish one audio asset per frozen chapter',
    'NORMAL', 'reader_synthesize_audiobook', '1.0.0', 'scripts/main.py', '[]', TRUE,
