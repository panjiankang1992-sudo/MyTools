...
def report(dry):return {"migrationKey":"catalog-v1","dryRun":dry,"sourceHighWater":"9","apps":2,"versions":3,"files":4,"accepted":2,"skipped":0,"rejected":0,"digestSha256":"a"*64,"targetVerified":not dry}
def replay():return {**report(False),"accepted":0,"skipped":2}
def target():return {"migrationKey":"catalog-v1","appCount":2,"versionCount":3,"fileCount":4,"collectionSha256":"a"*64}
