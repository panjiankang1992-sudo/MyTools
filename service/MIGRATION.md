...
- [ ] Asset Registry。已建立独立 `mytools_asset` schema、按 SHA-256 与大小去重的资产、跨租户业务来源、存储位置、派生关系、乐观版本、幂等写入和事务 Outbox；已建立共享 `asset_register_content` 脚本与 SDK，并以可忽略、可补偿步骤接入 Reader 电子书导入。下载、媒体登记旁路、资源包及旧 ID 映射待迁移。
