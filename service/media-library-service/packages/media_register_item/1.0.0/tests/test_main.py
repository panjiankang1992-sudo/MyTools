...
class MediaRegisterTest(unittest.TestCase):
 def test_does_not_send_physical_path(self):
  with tempfile.TemporaryDirectory()as directory:
   ...
   result=MODULE.execute({"taskInstanceId":"00000000-0000-4000-8000-000000000001","parameters":{"assetId":"42","sourcePath":str(source),"contentSha256":"a"*64,"assetMimeType":"video/mp4"},"stepOutputs":{"probe":{"durationMs":1},"register_asset":{"assetId":"00000000-0000-4000-8000-000000000003"}}},"http://media","token",requester)
   self.assertEqual(5,captured["body"]["sizeBytes"]);self.assertNotIn(str(source),json.dumps(captured["body"]));self.assertEqual("00000000-0000-4000-8000-000000000003",result["assetId"])
