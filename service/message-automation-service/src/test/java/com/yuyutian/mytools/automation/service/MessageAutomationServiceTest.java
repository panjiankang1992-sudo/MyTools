...
class MessageAutomationServiceTest {
    ...
    void shouldCreateBoundedDownloadsForAuthorizedMessageOnlyOnce() {
        ...
        when(downloadClient.create(any(), any(), anyInt(), anyString(), anyString(), anyString()))
                .thenAnswer(invocation -> "download-" + invocation.getArgument(2));
        ...
        verify(downloadClient, times(2)).create(any(), any(), anyInt(), anyString(), anyString(), anyString());
    ...
    void shouldRejectMessageOutsideAuthorizedSenderScope() {
        ...
        verify(downloadClient, never()).create(any(), any(), anyInt(), anyString(), anyString(), anyString());
    }
